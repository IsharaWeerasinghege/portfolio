            ...
            <div className="px-1 md:px-12 animate-slide-left">
                ...
                <div className="flex justify-between flex-wrap items-center">
                    {services.map((service, index) => (
                        <div className="w-full md:w-[300px] bg-neutral-700 md:min-h-[340px] p-8 mx-2 mb-3">
                            <span
                                className="w-14 h-14 bg-neutral-800 flex justify-center items-center rounded-full mb-3 text-neutral-100">{index}</span>
