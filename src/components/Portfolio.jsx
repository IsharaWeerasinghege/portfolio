                    ...
                    <div className="text-right text-neutral-400 flex flex-wrap">
                        {['All', 'Next App', 'React App', 'Other'].map((item) => (
                            <div
                                ...
                                className={`mx-2 hover:text-white transition-all last:mr-0 duration-300 ease-in-out cursor-pointer ${activeFilter === item ? 'text-neutral-300 font-semibold' : ''}`}
                            >
                                {item}
                            </div>
                        ))}
                        ...
                        <div key={work.title} className="w-full sm:w-1/2 md:w-1/3 min-w-[300px] ">
                           <div className="bg-neutral-600 m-1 rounded-sm p-2 min-h-[370px] animate-slide-up">
                               <figure className="bg-neutral-800 relative rounded-sm overflow-hidden">
                                   <div className="absolute w-full h-full bg-neutral-400 mix-blend-multiply"></div>
                                   <img
                               ...
                               <div className="flex flex-row justify-start items-center">
                                   <a href={work?.projectLink} target="_blank"
                                      className="p-2 bg-neutral-500 rounded mr-1">Demo</a>
                                   <a href={work?.codeLink} target="_blank" className="p-2 bg-neutral-500 rounded">Code</a>
                               </div>
                           </div>
                        </div>
                    ))}
